...
9. create inventory file  #sudo vi inventory and add ip address of servers to connect to 

10. create playbook #sudo vi

#To test if ansible can connect to the servers
11. ansible all --key-file ~/.ssh/id_rsa -i inventory -m ping -u ec2-user

12. creat ansible.cfg file #sudo vi ansible.cfg
[defaults]
